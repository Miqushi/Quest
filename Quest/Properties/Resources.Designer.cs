...
namespace Quest.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Чтобы зайти в комнату, нужно нажать на дверь и также чтобы выйти из нее. Также можно нажать на первую кнопку вверху, чтобы вернуться в главный зал. Нажмите на предмет левой кнопкой мыши, чтобы приблизить и правой, чтобы отдалить. Нажмите на предмет два раза и появиться доп. информация (если она есть). Также вверху есть кнопка показать ответ, и открыть инвентарь..
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Вы заходите в четветый кабинет. На столе стоит какая-то шкатулка, скорее всего в ней ключ на выход. На двери замок из кнопок, может где-то есть подсказки, какие кнопки нажать?.
        /// </summary>
        internal static string riddle4_4 {
            get {
                return ResourceManager.GetString("riddle4_4", resourceCulture);
            }
        }
